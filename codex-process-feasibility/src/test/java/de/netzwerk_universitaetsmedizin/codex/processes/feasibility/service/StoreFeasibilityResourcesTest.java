...
public class StoreFeasibilityResourcesTest {
    ...
    public void testDoExecute() {
        ...
        when(execution.getVariable(ConstantsFeasibility.VARIABLE_MEASURE)).thenReturn(measure);
        when(execution.getVariable(ConstantsFeasibility.VARIABLE_LIBRARY)).thenReturn(library);

        final String id = "id-1234";
        final Bundle transactionResponse = new Bundle();
        transactionResponse.setEntry(List.of(
