...
public class SetupEvaluationSettingsTest {
    ...
    public void testDoExecute() throws Exception {
        ...
        var generalSettings = new FeasibilitySettings.GeneralSettings(DEFAULT_REQUEST_TASK_TIMEOUT);
        var settings = new FeasibilitySettings(Map.of(networkId, network), null, generalSettings);
