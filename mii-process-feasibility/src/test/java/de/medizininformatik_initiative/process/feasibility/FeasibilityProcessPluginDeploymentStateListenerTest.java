...
public class FeasibilityProcessPluginDeploymentStateListenerTest {
    ...
    void flareClientConnectionTestSucceeds() throws Exception {
        ...
        assertThat(out.toString(),
                containsString("Feasibility plugin connection test to Flare of FHIR store '%s' SUCCEEDED."
                        .formatted(storeId)));
    }
    ...
    void flareClientConnectionTestFails() throws Exception {
        ...
        assertThat(out.toString(),
                containsString(
                        format("Feasibility plugin connection test to Flare of FHIR store '%s' FAILED. Error: %s - %s",
