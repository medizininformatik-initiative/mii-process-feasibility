...
sed -i "s#<PROCESS_EVALUATION_STRATEGY>#${PROCESS_EVALUATION_STRATEGY:-cql}#" $CONFIG_FILE
sed -i "s#<PROCESS_EVALUATION_OBFUSCATE>#${PROCESS_EVALUATION_OBFUSCATE:-true}#" $CONFIG_FILE
